...
var AxiosService = /** @class */ (function () {
    ...
    // Example GET request
    AxiosService.prototype.get = function (url, config) {
    ...
    AxiosService.prototype.post = function (url, data, config) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    // Example PUT request
    AxiosService.prototype.put = function (url, data, config) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AxiosService.prototype.delete = function (url, config) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
